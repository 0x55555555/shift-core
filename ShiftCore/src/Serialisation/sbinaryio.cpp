...
void SBinarySaver::writeToDevice(QIODevice *device, const Entity *ent)
  {
  _root = ent;
  _device = device;
...
void SBinarySaver::setType(const PropertyInformation *)
  {
...
void SBinarySaver::write(const Property *)
  {
